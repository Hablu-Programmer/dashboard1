...
const SalesDetails = () =>  {
  return (
    <div className='p-4'>
        <ContentHeader title="Todays Sales" des="Sales Summery" />
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-5'>
          {
            ...
            SalesData.map((data)=> {
                return (
                  <div key={data.id} className={`bg-primary1 p-5 rounded-md`}>
                      ...
                      <div className='mt-2'>
                        ...
                        <p style={{color: data.color}} className='text-[8px] md:text-[10px] font-medium'>{data.des}</p>
                      </div>
                  </div>
                )
            })
